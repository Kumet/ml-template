...
from src.logger import EpochMetrics, TensorboardWriter
...
class BaseTrainer(metaclass=ABCMeta):
    ...
    def __init__(self, model, criterion, metric_ftns, optimizer, config, mlflow_writer):
        self.config = config
    ...
    def train(self):
        ...
        for epoch in range(self.start_epoch, self.epochs + 1):
            ...
            for k, v in result.items():
                self.mlflow_writer.log_metric(k, v)
